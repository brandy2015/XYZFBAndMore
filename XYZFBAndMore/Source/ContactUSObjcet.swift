...
//    ContactUSObjcet.shared.
    public static var shared = ContactUSObjcet(nav: UINavigationController())
    ...
    public func mailComposeController(_ controller: MFMailComposeViewController, didFinishWith result: MFMailComposeResult, error: Error?) {
        switch result.rawValue {
            ...
            case MFMailComposeResult.sent.rawValue      :     print("发送成功")
                XYZHUD.弹出popUPView(标题: "发送成功".localized(), 描述: "邮件已经成功发送给开发者".localized(), 颜色: UIColor.Succeeded)
            default:break
        }
...
//        let deviceModel = UIDevice.current.DeviceType   // 获取设备的型号
...
//        return (appVersion,appBuildVersion,appName ?? "VTLMaker")
//    }
//
//}
