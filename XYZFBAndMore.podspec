#
#  Be sure to run `pod spec lint XYZFBAndMore.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/brandy2015/XYZFBAndMore"
...
# s.dependency 'FileKit'
  ...
  s.platform     = :ios, "10.1"
  s.source       = { :git => "https://github.com/brandy2015/XYZFBAndMore.git", :tag => "1.0.1"}
...
#s.resources = "ADVProgressBar/Resources/*.png"
    ...
    s.resource_bundles = {
        'XYZFBAndMore' => ['XYZFBAndMore/Assets/*.png'],
        'XYZFBAndMore' => ['XYZFBAndMore/Source/*.xib']
    }
...
#{ :git => "http://EXAMPLE/XYZFBAndMore.git", :tag => "#{s.version}" }
...
#s.source_files  = "XYZFBAndMore"#, "XYZFBAndMore/**/*.{h,m}"
